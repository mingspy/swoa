...
namespace YJ.Platform
{
    ...
    {
        private YJ.Data.Interface.IWorkFlowComment dataWorkFlowComment;
        ...
        {
            string key = YJ.Utility.Keys.CacheKeys.WorkFlowComments.ToString();
            if (!fromCache)
            {
        ...
        {
            YJ.Cache.IO.Opation.Remove(YJ.Utility.Keys.CacheKeys.WorkFlowComments.ToString());
        }
        /// <summary>
        /// 刷新缓存
        /// </summary>
        ...
        {
            YJ.Cache.IO.Opation.Set(YJ.Utility.Keys.CacheKeys.WorkFlowComments.ToString(), getAllListByDb());
        }
        /// <summary>
        /// 得到一个用户的所有意见
        /// </summary>
        ...
        public List<string> GetListByUserID(Guid userID)
        {
            ...
            {
                if (commentsList.Contains(li.Item2))
                {
                    continue;
                }
