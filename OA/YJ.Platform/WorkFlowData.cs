...
namespace YJ.Platform
{
    ...
    {
        private YJ.Data.Interface.IWorkFlowData dataWorkFlowData;
        public WorkFlowData()
        {
        ...
        public string GetLinkFieldValue(string linkString, Guid instanceID)
        {
            ...
            if (array.Length == 3)
            {
                ...
                value = new YJ.Platform.DBConnection().GetFieldValue(array[2], key);
            }
            return value;
        }
        ...
        public Guid CreateData(Guid flowID, string pkValue)
        {
            ...
            YJ.Data.Model.WorkFlowData wfdata = new YJ.Data.Model.WorkFlowData();
