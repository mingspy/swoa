...
　　　　　　      var file = Request.Files[0];
                if (file.ContentLength > 0)
                {
                    ...
                    string filename = string.Concat(Server.MapPath(Url.Content("~/Content/UserSigns/")), YJ.Platform.Users.CurrentUserID, ".gif");
                    file1.SaveAs(filename);
                    YJ.Platform.Log.Add("修改了签名", filename, YJ.Platform.Log.Types.流程相关);
            ...
            if (!Request.Form["reset"].IsNullOrEmpty())
            {
                ...
                if (System.IO.File.Exists(filename))
                {
                    ...
                    YJ.Platform.Log.Add("恢复了签名", filename, YJ.Platform.Log.Types.流程相关);
                }
