...
namespace WebMvc.Controllers
{
    public class DictController : MyController
    {
        ...
        {
            YJ.Platform.Dictionary bdict = new YJ.Platform.Dictionary();
            YJ.Data.Model.Dictionary dict = null;
            ...
            if (collection != null)
            {
                ...
                if (!Request.Form["Delete"].IsNullOrEmpty())
                {
                    ...
                    bdict.RefreshCache();
                    YJ.Platform.Log.Add("删除了数据字典及其下级共" + i.ToString() + "项", dict.Serialize(), YJ.Platform.Log.Types.数据字典);
                ...
                bdict.Update(dict);
                bdict.RefreshCache();
                YJ.Platform.Log.Add("修改了数据字典项", "", YJ.Platform.Log.Types.数据字典, oldXML, dict.Serialize());
        ...
        { 
            ...
            return new YJ.Platform.Dictionary().HasCode(code, id) ? "唯一代码重复" : "1";
        }
        ...
        {
            YJ.Data.Model.Dictionary dict = new YJ.Data.Model.Dictionary();
            YJ.Platform.Dictionary bdict = new YJ.Platform.Dictionary();
            string id = Request.QueryString["id"];
            if (!id.IsGuid())
            {
            ...
            if (collection != null)
            {
                ...
                bdict.Add(dict);
                bdict.RefreshCache();
                YJ.Platform.Log.Add("添加了数据字典项", dict.Serialize(), YJ.Platform.Log.Types.数据字典);
        ...
        public ActionResult Sort(FormCollection collection)
        {
            ...
            string refreshID = "";
            Guid dictid;
            List<YJ.Data.Model.Dictionary> dicts = new List<YJ.Data.Model.Dictionary>();
            ...
            if (collection != null)
            {
                ...
                YJ.Platform.Log.Add("保存了数据字典排序", "保存了ID为：" + id + "的同级排序", YJ.Platform.Log.Types.数据字典);
