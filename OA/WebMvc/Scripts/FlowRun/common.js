...
function ceshi(isSubmit) {
     var mainDialog = top && top.mainDialog ? top.mainDialog : new RoadUI.Window();
    mainDialog.open({ url: "/ProgramBuilder/Run?programid=c5fa58d8-dfea-4786-910a-dab2db5f8b72" + "&instanceid1=" + $("#instanceid").val(), openerid: iframeid, width: ismobile ? 320 : 500, height: 300, title: "参会人员回执" });
}
