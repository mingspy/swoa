                ...
                <div id="select_base" style="padding-bottom:8px; padding-top:8px;" title="&nbsp;&nbsp;属性&nbsp;&nbsp;">
                    ...
                    <tr>
                        ...
                        <td>字段：<select id="select_Linkage_Field" class="myselect" style="width:180px;"></select>
                            ...
                            <div style="margin-top:6px; display:none;" id="select_Linkage_Source_sql_link">数据连接：<select class="myselect" id="select_Linkage_Source_sql_conn"><%=new YJ.Platform.DBConnection().GetAllOptions() %></select>
