...
<%
    ...
    YJ.Platform.WorkFlowForm workFlowFrom = new YJ.Platform.WorkFlowForm(); 
%>
<div class="wrapper">
    ...
    <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
        ...
        <tr id="ds_dict">
            ...
            <td><input type="text" class="mydict" id="ds_dict_value" more="0" value="" />
                ...
                <span style="margin-left:15px;">值字段：</span><select class="myselect" style="" id="ds_dict_valuefield">
                    <option value="YJ.Platform.Dictionary.OptionValueField.ID">ID</option>
                    <option value="YJ.Platform.Dictionary.OptionValueField.Code">唯一代码</option>
                    <option value="YJ.Platform.Dictionary.OptionValueField.Value">值</option>
                    <option value="YJ.Platform.Dictionary.OptionValueField.Title">标题</option>
                    <option value="YJ.Platform.Dictionary.OptionValueField.Note">备注</option>
                    <option value="YJ.Platform.Dictionary.OptionValueField.Other">其他</option>
                </select>
            </td>
        </tr>  
                ...
                <table border="0" style="width:100%;">
                    ...
                    <tr>
                        <td colspan="2" style="padding-top:4px;">
                            <div>数据连接：<select class="myselect" id="ds_sql_dbconn"><%=new YJ.Platform.DBConnection().GetAllOptions() %></select>
        ...
        <tr>
            ...
            <td>字段：<select id="Linkage_Field" class="myselect" style="width:180px;"></select>
                ...
                <div style="margin-top:6px; display:none;" id="Linkage_Source_sql_link">数据连接：<select class="myselect" id="Linkage_Source_sql_conn"><%=new YJ.Platform.DBConnection().GetAllOptions() %></select>
