...
<table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
    <tr>
        ...
        <td>
            <select class="myselect" id='event_name<%=Request.QueryString["elementtype"] %>' onchange="event_change(this.value,'<%=Request.QueryString["elementtype"] %>','<%=Request.QueryString["field"] %>');"><option value=""></option><%=new YJ.Platform.WorkFlowForm().GetEventOptions("","","") %></select>
        </td>
    </tr>
    <tr>
        <th>事件脚本:</th>
